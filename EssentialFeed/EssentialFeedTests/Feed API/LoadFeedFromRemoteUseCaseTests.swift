...
class LoadFeedFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWithReslt: failure(.connectivity)) {
    ...
    func test_load_deliversErrorOnNon200HTTPResonse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWithReslt: failure(.invalidData)) {
    ...
    func test_load_deliversNoItemsOn200HTTPResponseWithEmptyJSONList() {
        ...
        expect(sut, toCompleteWithReslt: .success([])) {
    ...
    func test_load_deliversItemsOn200HTTResponseWithJSONItems() {
        ...
        expect(sut, toCompleteWithReslt: .success(items)) {
    ...
    private func expect(_ sut: RemoteFeedLoader,
                        toCompleteWithReslt expectedResult: RemoteFeedLoader.Result,
